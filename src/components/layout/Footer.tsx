  ...
  return (
    <footer className='footer'>
      <div className='feedback p-5 bg-[#eceff1] lg:hidden'>
        ...
        <p className='mb-4'>We strive to serve you better and appreciate your feedback</p>
      ...
      <div className='hidden md:block bg-primary text-secondary py-20 px-15'>
        <div className='max-w-3xl mx-auto'>
          <div className='mb-10'>
            <h1 className='text-center mb-4'>STORIES, STYLES AND SPORTSWEAR AT ADIDAS, SINCE 1949</h1>
            <p className='mb-4'>
              ...
              Sportswear featuring the latest technologies, to up your performance. Beat your PB.adidas offers a home to
              the runner, the basketball player, the soccer kid, the fitness enthusiast. The weekend hiker that loves to
              escape the city. The yoga teacher that spreads the moves. The 3-Stripes are seen in the music scene. On
              stage, at festivals. Our sports clothing keeps you focused before that whistle blows. During the race. And
              at the finish lines. We’re here to supportcreators. Improve their game. Their lives. And change the world.
            </p>
            <p>
                ...
                {section.links.map((link, i) => (
                  <li key={i}>
                    <Link to={link.link} className='py-1 block'>
                      <span className={section.isIcon ? 'text-2xl' : ''}>{link.name}</span>
                    </Link>
                  </li>
                ))}
              </ul>
